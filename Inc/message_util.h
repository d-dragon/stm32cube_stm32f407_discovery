...
typedef enum {
	...
	MATLAB_CMD_READ_ADC,
	MATLAB_CMD_GET_POS,
	MATLAB_CMD_RESET_ENCODER_COUNTER,
	MATLAB_CMD_REP_POS
}MatLab_Cmd_Type;

typedef enum {
	MSG_REPLY_ACK = 0,
	MSG_REPLY_NAK_CRC_ERR,
	MSG_REPLY_NAK_CMD_INVALID,
	MSG_REPLY_NAK_RUN_ERROR,
 	MSG_REPLY_NAK_INVALID_FORMAT
} Reply_Message_Error_Code;
